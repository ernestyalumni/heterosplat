 ...
 *
 * Derived from gsplat's cuda/csrc/ProjectionEWA3DGSFused.cu at
 ...
 * - Dropped the ATen launch_* host wrappers, AT_DISPATCH_* macros, and
 *   GSPLAT_BUILD_3DGS config guard.
