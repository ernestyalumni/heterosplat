 ...
 * The __global__ kernels below were extracted verbatim from upstream
 * gsplat's QuatScaleToCovarCUDA.cu. The accompanying launch_* host
 * functions and the AT_DISPATCH_FLOATING_TYPES dispatch are NOT carried
 * over: heterosplat replaces them with raw-pointer launchers in
 * ../../Heterosplat/QuatScaleToCovar.cu.
 */
