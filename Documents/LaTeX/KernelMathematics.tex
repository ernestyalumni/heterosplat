...
EWA projection and the tile-rasterizer (forward + backward). Each
follows the same template: source-file pointers, the forward map in
coordinate-free form, the VJP derivation when applicable, the
launcher API correspondence, and the test correspondence.
